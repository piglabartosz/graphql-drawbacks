...
/**
 * I need to write boilerplate code for Instant handling because even separate dependency containing extended scalars
 * (ExtendedScalars.DateTime) does not handle Instant
 */
@Component
